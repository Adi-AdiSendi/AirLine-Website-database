...
<body>
	...
	<div class="info">
		...
		<div id="info_txt">
			...
			<br>
			<p>
			The only thing you have to do is <a href="registration.html" title="Registration"> register here</a> and start flying with
			the best airline software wordlwide! <br>
			</p>
			<p>
				You Already Have an account! login in now and Enjoy our deal  <a href="Login.html" title="Login"> register here</a> and start flying with
				the best airline software wordlwide! <br>
				</p>
